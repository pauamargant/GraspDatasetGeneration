...
def generate_scene(
    ...
    # Generate scenes
    obj_files = get_obj_filenames(shapenet_path, cc_textures, type=dataset_type, categories_file='custom_scripts/categories.txt')
...
if __name__ == "__main__":
    ...
    with open('custom_scripts/config.json') as f:
        config = json.load(f)
    print("---"*10)
    print("STARTING")
    print("---"*10)
